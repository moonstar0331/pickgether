...
-- 5 users
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at) values ('cvaldes0', '{noop}11tMPQ4', 'bscrivenor0@bluehost.com', 'Skiles and Sons', 'Optimized tangible customer loyalty', '2021-07-31 05:54:08', '2022-05-13 02:43:28');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at) values ('lness1', '{noop}aA7tIdKQAL5', 'vkilcullen1@etsy.com', 'Nikolaus-Feest', 'Enhanced secondary website', '2020-10-18 06:22:01', '2021-06-08 06:05:49');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at) values ('hcampa2', '{noop}UCaygi', 'lretchless2@wordpress.org', 'Bins, Baumbach and Russel', 'Multi-tiered interactive access', '2021-08-06 22:23:09', '2022-02-15 18:57:26');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at) values ('tjackalin3', '{noop}gLmKrEwLUO', 'chedling3@i2i.jp', 'Hand-Stamm', 'Adaptive intermediate task-force', '2022-10-08 06:43:59', '2022-02-02 11:37:00');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at) values ('rclayson4', '{noop}IVKw1XpapbzR', 'bbevis4@ehow.com', 'Strosin-O''Kon', 'Universal modular website', '2023-02-24 02:29:58', '2021-01-04 00:54:05');

-- 10 votes
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (1, 'cvaldes0', 'Monsturd', 'Integrated #intermediate functionalities', 'ALL', '2023-01-02 17:18:40', '2023-02-10 11:33:14', '2021-04-11 07:35:55', 'PUBLIC', true);
...
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (3, 'lness1', 'Expelled', 'Inverse user-facing #interface', 'ALL', '2022-07-31 21:42:57', '2021-05-24 05:16:01', '2021-12-31 15:59:36', 'PUBLIC', false);
...
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (5, 'hcampa2', 'Hair Show', 'Pre-emptive maximized #hub', 'ALL', '2022-10-30 14:39:50', '2022-09-12 13:27:59', '2023-01-08 11:09:39', 'PUBLIC', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (6, 'hcampa2', 'God''s Comedy (A Comédia de Deus)', 'Fully-configurable high-level #data-warehouse', 'WORRY', '2022-09-11 17:28:16', '2021-02-25 20:20:31', '2021-08-03 04:47:17', 'PUBLIC', false);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (7, 'tjackalin3', 'Guilty #Hands', 'Profit-focused high-level #protocol', 'ALL', '2022-09-04 00:48:32', '2021-09-26 11:03:36', '2021-12-13 12:09:56', 'PUBLIC', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (8, 'tjackalin3', 'Ivan the Terrible, Part Two (Ivan Groznyy II: Boyarsky zagovor)', 'Polarised composite #interface', 'ALL', '2023-01-12 09:24:16', '2020-10-29 15:06:22', '2020-12-26 06:09:46', 'FRIEND', true);
