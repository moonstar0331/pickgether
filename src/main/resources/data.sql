...
-- 5 users
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('cvaldes0', '{noop}11tMPQ4', 'bscrivenor0@bluehost.com', 'Skiles and Sons', 'Optimized tangible customer loyalty', '2021-07-31 05:54:08', '2022-05-13 02:43:28', 'male', '20', 'expert', '경기 수원시 장안구 경수대로 769 (청송빌딩)');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('lness1', '{noop}aA7tIdKQAL5', 'vkilcullen1@etsy.com', 'Nikolaus-Feest', 'Enhanced secondary website', '2020-10-18 06:22:01', '2021-06-08 06:05:49', 'male', '30', 'office', '충북 음성군 음성읍 가섭길 568');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('hcampa2', '{noop}UCaygi', 'lretchless2@wordpress.org', 'Bins, Baumbach and Russel', 'Multi-tiered interactive access', '2021-08-06 22:23:09', '2022-02-15 18:57:26', 'male', '20', 'service', '서울 송파구 동남로 99 (용현빌딩)');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('tjackalin3', '{noop}gLmKrEwLUO', 'chedling3@i2i.jp', 'Hand-Stamm', 'Adaptive intermediate task-force', '2022-10-08 06:43:59', '2022-02-02 11:37:00', 'female', '10', 'sail', '경기 성남시 분당구 서판교로 32');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('rclayson4', '{noop}IVKw1XpapbzR', 'bbevis4@ehow.com', 'Strosin-O''Kon', 'Universal modular website', '2023-02-24 02:29:58', '2021-01-04 00:54:05', 'female', '20', 'expert', '경기 수원시 영통구 광교산로 154-42 (경기대학교)');
