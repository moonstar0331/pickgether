-- users
insert into user (user_Id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user', '{noop}password', 'email@email.com', 'nick', 'memo', '1971-03-13T00:00:00', '남성', now(), '50대', 'expert', '경기');
...
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('lness1', '{noop}aA7tIdKQAL5', 'vkilcullen1@etsy.com', 'Nikolaus-Feest', 'Enhanced secondary website', '2021-06-08 06:05:49', '남성', '1991-02-02', '30대', 'office', '충북');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('hcampa2', '{noop}UCaygi', 'lretchless2@wordpress.org', 'Bins, Baumbach and Russel', 'Multi-tiered interactive access', '2022-02-15 18:57:26', '남성', '1999-04-01', '20대', 'service', '서울');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('tjackalin3', '{noop}gLmKrEwLUO', 'chedling3@i2i.jp', 'Hand-Stamm', 'Adaptive intermediate task-force', '2022-02-02 11:37:00', '여성', '2011-10-10', '10대', 'student', '경기');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('rclayson4', '{noop}IVKw1XpapbzR', 'bbevis4@ehow.com', 'Strosin-O''Kon', 'Universal modular website', '2021-01-04 00:54:05', '여성', '1971-08-22', '50대', 'sales', '경기');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user1', '{noop}password1', 'user1@test.com', 'user1', 'memo1', '2023-04-12 00:00:00', '남성', '1990-01-01 00:00:00', '30대', 'office', '울산');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user2', '{noop}password2', 'user2@test.com', 'user2', 'memo2', '2023-04-12 00:00:00', '남성', '1991-01-01 00:00:00', '30대', 'sales', '대구');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user3', '{noop}password3', 'user3@test.com', 'user3', 'memo3', '2023-04-12 00:00:00', '여성', '1992-01-01 00:00:00', '30대', 'sales', '부산');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user4', '{noop}password4', 'user4@test.com', 'user4', 'memo4', '2023-04-12 00:00:00', '여성', '1993-01-01 00:00:00', '30대', 'office', '인천');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user5', '{noop}password5', 'user5@test.com', 'user5', 'memo5', '2023-04-12 00:00:00', '남성', '1994-01-01 00:00:00', '30대', 'expert', '광주');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user6', '{noop}password6', 'user6@test.com', 'user6', 'memo6', '2023-04-12 00:00:00', '여성', '1995-01-01 00:00:00', '20대', 'office', '광주');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user7', '{noop}password7', 'user7@test.com', 'user7', 'memo7', '2023-04-12 00:00:00', '남성', '1996-01-01 00:00:00', '20대', 'expert', '광주');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user8', '{noop}password8', 'user8@test.com', 'user8', 'memo8', '2023-04-12 00:00:00', '여성', '1997-01-01 00:00:00', '20대', 'service', '대전');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user9', '{noop}password9', 'user9@test.com', 'user9', 'memo9', '2023-04-12 00:00:00', '남성', '1998-01-01 00:00:00', '20대', 'service', '울산');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user10', '{noop}password10', 'user10@test.com', 'user10', 'memo10', '2023-04-12 00:00:00', '남성', '1999-01-01 00:00:00', '20대', 'service', '강원');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user11', '{noop}password11', 'user11@test.com', 'user11', 'memo11', '2023-04-12 00:00:00', '여성', '2000-01-01 00:00:00', '20대', 'service', '충북');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user12', '{noop}password12', 'user12@test.com', 'user12', 'memo12', '2023-04-12 00:00:00', '여성','2001-01-01 00:00:00', '20대', 'expert', '충북');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user13', '{noop}password13', 'user13@test.com', 'user13', 'memo13', '2023-04-12 00:00:00', '여성', '2002-01-01 00:00:00', '20대', 'service', '충남');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user14', '{noop}password14', 'user14@test.com', 'user14', 'memo14', '2023-04-12 00:00:00', '여성', '2003-01-01 00:00:00', '20대', 'office', '전남');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user15', '{noop}password15', 'user15@test.com', 'user15', 'memo15', '2023-04-12 00:00:00', '남성', '2004-01-01 00:00:00', '20대', 'sales', '전북');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user16', '{noop}password16', 'user16@test.com', 'user16', 'user16', '2023-04-12 00:00:00', '여성', '2005-01-01 00:00:00', '10대', 'student', '경남');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user17', '{noop}password17', 'user17@test.com', 'user17', 'user17', '2023-04-12 00:00:00', '여성', '2006-01-01 00:00:00', '10대', 'student', '경북');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user18', '{noop}password18', 'user18@test.com', 'user18', 'user18', '2023-04-12 00:00:00', '남성', '2007-01-01 00:00:00', '10대', 'student', '세종특별자치시');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user19', '{noop}password19', 'user19@test.com', 'user19', 'user19', '2023-04-12 00:00:00', '여성', '2008-01-01 00:00:00', '10대', 'student', '서울');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user20', '{noop}password20', 'user20@test.com', 'user20', 'user20', '2023-04-12 00:00:00', '여성', '2009-01-01 00:00:00', '10대', 'student', '서울');

-- 10 votes
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, gender_restriction, age_restriction, is_multi_pick) values (1, 'cvaldes0', 'Monsturd', 'Integrated #intermediate functionalities', 'ENTERPRISE', '2023-11-02 17:18:40', '2023-02-10 11:33:14', '2021-04-11 07:35:55', 'PUBLIC', 'All', 'All', 'All', true);
...
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, gender_restriction, age_restriction, is_multi_pick) values (5, 'hcampa2', 'Hair Show', 'Pre-emptive maximized #hub', 'SURVEY', '2023-10-30 14:39:50', '2022-09-12 13:27:59', '2023-01-08 11:09:39', 'PUBLIC', 'All', 'All', 'All', true);
