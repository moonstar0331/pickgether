-- users
insert into user (user_Id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user', '{noop}password', 'email@email.com', 'nick', 'memo', '1971-03-13T00:00:00', '남성', now(), '50대', 'expert', '경기 성남시 분당구 금곡로 39 (화이트빌)');
...
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('tjackalin3', '{noop}gLmKrEwLUO', 'chedling3@i2i.jp', 'Hand-Stamm', 'Adaptive intermediate task-force', '2022-02-02 11:37:00', '여성', '2011-10-10', '10대', 'student', '경기 성남시 분당구 서판교로 32');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('rclayson4', '{noop}IVKw1XpapbzR', 'bbevis4@ehow.com', 'Strosin-O''Kon', 'Universal modular website', '2021-01-04 00:54:05', '여성', '1971-08-22', '50대', 'sales', '경기 수원시 영통구 광교산로 154-42 (경기대학교)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user1', 'password1', 'user1@test.com', 'user1', 'memo1', '2023-04-12 00:00:00', '남성', '1990-01-01 00:00:00', '30대', 'office', '울산 북구 가대서길 25');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user2', 'password2', 'user2@test.com', 'user2', 'memo2', '2023-04-12 00:00:00', '남성', '1991-01-01 00:00:00', '30대', 'sales', '대구 남구 경상길 1');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user3', 'password3', 'user3@test.com', 'user3', 'memo3', '2023-04-12 00:00:00', '여성', '1992-01-01 00:00:00', '30대', 'sales', '부산 강서구 가달1로 7');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user4', 'password4', 'user4@test.com', 'user4', 'memo4', '2023-04-12 00:00:00', '여성', '1993-01-01 00:00:00', '30대', 'office', '인천 남동구 간석로 1');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user5', 'password5', 'user5@test.com', 'user5', 'memo5', '2023-04-12 00:00:00', '남성', '1994-01-01 00:00:00', '30대', 'expert', '광주 동구 경양로 211');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user6', 'password6', 'user6@test.com', 'user6', 'memo6', '2023-04-12 00:00:00', '여성', '1995-01-01 00:00:00', '20대', 'office', '광주 북구 가사문학로 954-38');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user7', 'password7', 'user7@test.com', 'user7', 'memo7', '2023-04-12 00:00:00', '남성', '1996-01-01 00:00:00', '20대', 'expert', '광주 남구 대지상촌길 1');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user8', 'password8', 'user8@test.com', 'user8', 'memo8', '2023-04-12 00:00:00', '여성', '1997-01-01 00:00:00', '20대', 'service', '대전 대덕구 대화로50번길 76 (행복아파트)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user9', 'password9', 'user9@test.com', 'user9', 'memo9', '2023-04-12 00:00:00', '남성', '1998-01-01 00:00:00', '20대', 'service', '울산 남구 거마로 5');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user10', 'password10', 'user10@test.com', 'user10', 'memo10', '2023-04-12 00:00:00', '남성', '1999-01-01 00:00:00', '20대', 'service', '강원 삼척시 강원남부로 4330 (영진산업개발)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user11', 'password11', 'user11@test.com', 'user11', 'memo11', '2023-04-12 00:00:00', '여성', '2000-01-01 00:00:00', '20대', 'service', '충북 영동군 양강면 유점지촌길 372 (충남대학교학술림)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user12', 'password12', 'user12@test.com', 'user12', 'memo12', '2023-04-12 00:00:00', '여성','2001-01-01 00:00:00', '20대', 'expert', '충북 음성군 음성읍 가섭길 578');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user13', 'password13', 'user13@test.com', 'user13', 'memo13', '2023-04-12 00:00:00', '여성', '2002-01-01 00:00:00', '20대', 'service', '충남 금산군 진산면 실학로 520-25 (대한불교조계종금강불교대학부설원적선원)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user14', 'password14', 'user14@test.com', 'user14', 'memo14', '2023-04-12 00:00:00', '여성', '2003-01-01 00:00:00', '20대', 'office', '전남 광양시 광양읍 대학로 85 (광양보건대학)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user15', 'password15', 'user15@test.com', 'user15', 'memo15', '2023-04-12 00:00:00', '남성', '2004-01-01 00:00:00', '20대', 'sales', '전북 군산시 대학로 588 (군산대학교)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user16', 'password16', 'user16@test.com', 'user16', 'user16', '2023-04-12 00:00:00', '여성', '2005-01-01 00:00:00', '10대', 'student', '경남 거제시 마전1길 91 (거제대학)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user17', 'password17', 'user17@test.com', 'user17', 'user17', '2023-04-12 00:00:00', '여성', '2006-01-01 00:00:00', '10대', 'student', '경북 경산시 경청로222길 33 (대신대학교)');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user18', 'password18', 'user18@test.com', 'user18', 'user18', '2023-04-12 00:00:00', '남성', '2007-01-01 00:00:00', '10대', 'student', '세종특별자치시 전의면 가나물길 13');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user19', 'password19', 'user19@test.com', 'user19', 'user19', '2023-04-12 00:00:00', '여성', '2008-01-01 00:00:00', '10대', 'student', '서울 동대문구 서울시립대로 7');
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('user20', 'password20', 'user20@test.com', 'user20', 'user20', '2023-04-12 00:00:00', '여성', '2009-01-01 00:00:00', '10대', 'student', '서울 영등포구 당산로 123 (영등포구청)');
