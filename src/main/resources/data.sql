...
-- 5 users
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('cvaldes0', '{noop}11tMPQ4', 'bscrivenor0@bluehost.com', 'Skiles and Sons', 'Optimized tangible customer loyalty', '2021-07-31 05:54:08', '2022-05-13 02:43:28', 'male', '20', 'Professional occupation', 'Gyeonggi-do');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('lness1', '{noop}aA7tIdKQAL5', 'vkilcullen1@etsy.com', 'Nikolaus-Feest', 'Enhanced secondary website', '2020-10-18 06:22:01', '2021-06-08 06:05:49', 'male', '30', 'Administrative occupation', 'Jeollanam-do');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('hcampa2', '{noop}UCaygi', 'lretchless2@wordpress.org', 'Bins, Baumbach and Russel', 'Multi-tiered interactive access', '2021-08-06 22:23:09', '2022-02-15 18:57:26', 'male', '20', 'Service occupation', 'Jeollabuk-do');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('tjackalin3', '{noop}gLmKrEwLUO', 'chedling3@i2i.jp', 'Hand-Stamm', 'Adaptive intermediate task-force', '2022-10-08 06:43:59', '2022-02-02 11:37:00', 'female', '10', 'Sales occupation', 'Chungcheongbuk-do');
insert into user (user_id, user_password, email, nickname, memo, birthday, created_at, gender, age_range, job, address) values ('rclayson4', '{noop}IVKw1XpapbzR', 'bbevis4@ehow.com', 'Strosin-O''Kon', 'Universal modular website', '2023-02-24 02:29:58', '2021-01-04 00:54:05', 'female', '20', 'Professional occupation', 'Chungcheongbuk-do');
...
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (4, 'lness1', 'Revengers Tragedy', 'Phased #national productivity', 'FREE', '2022-10-31 19:26:14', '2020-08-12 15:50:03', '2020-11-12 23:49:37', 'FRIEND', false);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (5, 'hcampa2', 'Hair Show', 'Pre-emptive maximized #hub', 'SURVEY', '2022-10-30 14:39:50', '2022-09-12 13:27:59', '2023-01-08 11:09:39', 'PUBLIC', true);
...
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, is_multi_pick) values (7, 'tjackalin3', 'Guilty #Hands', 'Profit-focused high-level #protocol', 'SURVEY', '2022-09-04 00:48:32', '2021-09-26 11:03:36', '2021-12-13 12:09:56', 'PUBLIC', true);
