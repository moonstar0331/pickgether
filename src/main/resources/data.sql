...
insert into user (user_id, user_password, email, nickname, memo, created_at, gender, birthday, age_range, job, address) values ('tjackalin3', '{noop}gLmKrEwLUO', 'chedling3@i2i.jp', 'Hand-Stamm', 'Adaptive intermediate task-force', '2022-02-02 11:37:00', 'female', '2011-10-10', '10대', 'sail', '경기 성남시 분당구 서판교로 32');
...
-- 10 votes
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (1, 'cvaldes0', 'Monsturd', 'Integrated #intermediate functionalities', 'ENTERPRISE', '2023-01-02 17:18:40', '2023-02-10 11:33:14', '2021-04-11 07:35:55', 'PUBLIC', 'All', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (2, 'cvaldes0', 'Raincoat', 'Switchable fresh-thinking #secured line', 'SURVEY', '2022-03-28 16:01:59', '2022-06-09 02:20:49', '2021-04-07 01:20:52', 'PUBLIC', 'Seoul', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (3, 'lness1', 'Expelled', 'Inverse user-facing #interface', 'FREE', '2022-07-31 21:42:57', '2021-05-24 05:16:01', '2021-12-31 15:59:36', 'PUBLIC', 'Incheon', false);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (4, 'lness1', 'Revengers Tragedy', 'Phased #national productivity', 'FREE', '2022-10-31 19:26:14', '2020-08-12 15:50:03', '2020-11-12 23:49:37', 'FRIEND', 'Busan', false);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (5, 'hcampa2', 'Hair Show', 'Pre-emptive maximized #hub', 'SURVEY', '2022-10-30 14:39:50', '2022-09-12 13:27:59', '2023-01-08 11:09:39', 'PUBLIC', 'All', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (6, 'hcampa2', 'God''s Comedy (A Comédia de Deus)', 'Fully-configurable high-level #data-warehouse', 'WORRY', '2022-09-11 17:28:16', '2021-02-25 20:20:31', '2021-08-03 04:47:17', 'PUBLIC', 'All', false);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (7, 'tjackalin3', 'Guilty #Hands', 'Profit-focused high-level #protocol', 'SURVEY', '2022-09-04 00:48:32', '2021-09-26 11:03:36', '2021-12-13 12:09:56', 'PUBLIC', 'Seoul', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (8, 'tjackalin3', 'Ivan the Terrible, Part Two (Ivan Groznyy II: Boyarsky zagovor)', 'Polarised composite #interface', 'WORRY', '2023-01-12 09:24:16', '2020-10-29 15:06:22', '2020-12-26 06:09:46', 'FRIEND', 'All', true);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (9, 'rclayson4', 'Lucky Night', '#Innovative mission-critical artificial intelligence', 'FREE', '2022-07-05 12:07:09', '2021-02-15 18:33:55', '2020-12-07 09:52:28', 'FRIEND', 'All', false);
insert into vote (vote_id, user_id, title, content, category, expired_at, create_at, modified_at, display_range, region_restriction, is_multi_pick) values (10, 'rclayson4', 'Scalphunters, The', 'Centralized fault-tolerant #structure', 'WORRY', '2023-03-13 11:00:24', '2021-06-19 20:38:28', '2021-04-04 15:15:26', 'PUBLIC', 'All', false);
